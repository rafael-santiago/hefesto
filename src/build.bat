...
@SET UNIT_TEST=-omain.exe ../../dbg.o ../../dep_chain.o ../../expr_handler.o ../../exprchk.o ../../file_io.o ../../hlsc_msg.o ../../htask.o ../../hvm.o ../../hvm_alu.o ../../hvm_func.o ../../hvm_list.o ../../hvm_rqueue.o ../../hvm_str.o ../../hvm_syscall.o ../../hvm_thread.o ../../hvm_toolset.o ../../init.o ../../lang_defs.o ../../mem.o ../../os_detect.o ../../parser.o ../../src_chsum.o ../../structs_io.o ../../synchk.o ../../types.o ../../vfs.o main.o htest.o ../../hvm_project.o ../../hvm_winreg.o ../../ivk.o ../../hvm_mod.o ../../conv.o cute.o cute_memory.o cute_mmap.o ../../here/src/libhere.a %ADVAPI32LIB%
...
@cd tests\unit
@%COMPILER% -c main.c -I../../here/src -Icute/src
@IF %ERRORLEVEL% NEQ 0 ( GOTO UNIT_TEST_COMPILATION_FAIL )
